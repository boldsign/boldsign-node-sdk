...
import {
    ...
    CreateUser,ErrorResult,UpdateUser,UserProperties,UserRecords,
} from '../model';
...
export class UserApi {
     ...
     * @param options
     */
    public async getUser (userId: string, options: optionsI = {headers: {}}) : Promise<returnTypeT<UserProperties>> {
        ...
        return interceptorPromise.then(() => {
            return new Promise<returnTypeT<UserProperties>>((resolve, reject) => {
                axios.request(localVarRequestOptions)
                    .then((response) => {
     ...
     * @param options
     */
    public async listUsers (page: number, pageSize?: number, search?: string, options: optionsI = {headers: {}}) : Promise<returnTypeT<UserRecords>> {
        ...
        return interceptorPromise.then(() => {
            return new Promise<returnTypeT<UserRecords>>((resolve, reject) => {
                axios.request(localVarRequestOptions)
                    .then((response) => {
